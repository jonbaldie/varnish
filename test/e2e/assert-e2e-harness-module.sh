...
echo "$unknown_output" | grep -q 'Available scenarios: static-cookie, account-cookie, set-cookie, query-suffix, 5xx, post, grace, purge-acl, vary-star, authorization, zero-ttl' || {
